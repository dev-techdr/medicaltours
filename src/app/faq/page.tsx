...
export const metadata: Metadata = buildMetadata({
  ...
  description:
    "Answers to common questions about medical tourism in India: safety, costs, visas, hospitals, and how Techdr Medical Tourism works.",
  path: "/faq",
  keywords: [
    ...
    <Container className="py-10 sm:py-14">
      ...
      <div className="mt-6">
        <AnswerBlock>
          ...
          India — safety, costs, medical visas, hospital selection, and how Techdr coordinates your
          full treatment journey.
        </AnswerBlock>
      </div>
      <div className="mt-10 space-y-12">
        <FAQAccordion faqs={globalFaqs} title="General Medical Tourism Questions" />
