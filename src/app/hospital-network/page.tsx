    ...
    <>
      ...
      <section className="relative min-h-[420px] overflow-hidden border-b border-line sm:min-h-[480px]">
        ...
        <Container className="relative py-14 sm:py-20">
          <div className="hero-enter max-w-3xl text-white">
            <p className="text-sm font-semibold text-white/80">Trusted hospital partners</p>
            ...
            <p className="mt-6 text-base leading-relaxed text-white/80 sm:text-lg">
              ...
              Hyderabad, Delhi NCR, Chennai, Mumbai, Bangalore, and beyond.
            </p>
            <div className="mt-10">
              <TrustBadges />
            </div>
